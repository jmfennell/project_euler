...
def largest_diagonal_lr_product():
	products = []
	for i in range(0, len(grid) - 3):
...
def largest_diagonal_rl_product():
	products = []
	for i in range(0, len(grid) - 3):
...
def main():
	products = []
	products.append(largest_horizontal_product())
	products.append(largest_vertical_product())
	products.append(largest_diagonal_lr_product())
	products.append(largest_diagonal_rl_product())
	print(max(products))
